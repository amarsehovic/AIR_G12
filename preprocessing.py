...
def preprocess_data(testing=False):
    ...
    #reduce dataset if the testing flag is True(just for testing!!!!!!!)
    if testing:
...
if __name__ == "__main__":
    movies, ratings, user_profiles = preprocess_data(testing=False)  # Set testing to True for reduced dataset
